...
public class Sample04_LocalDate {
	...
	public static void main(String[] args) {
		...
		System.out.printf("%s에서 오늘은 %d일 입니다.\n", date1, date1.getDayOfMonth());
		System.out.printf("%s에서 오늘은 %s 입니다.\n", date1, date1.getDayOfWeek());
		System.out.printf("%s에서 오늘은 %s 입니다.\n", date1, date1.getMonth());
		System.out.printf("%s에서 오늘은 %s월 입니다.\n", date1, date1.getMonthValue());
		System.out.printf("%s에서 오늘은 %s년 입니다.\n", date1, date1.getYear());
		
		System.out.printf("%s는 1945-01-01로 부터 총 %d일이 지났습니다.\n\n", date2, date2.getDayOfYear());
		
		System.out.printf("1년 전의 날짜는 %s\n", date1.minusYears(1).getYear());
		System.out.printf("6개월 전의 날짜는 %s\n", date1.minusMonths(6));
		System.out.printf("3일 전의 날짜는 %s\n", date1.minusDays(3));
		System.out.printf("3주 전의 날짜는 %s\n\n", date1.minusWeeks(3));
		
		System.out.printf("1년 후의 날짜는 %s\n", date1.plusYears(1).getYear());
